...
You may call one or more functions to assist with the user query. But if you think a query can be satisfied without using any tools then return no JSON.

 Don't make assumptions about what values to plug
